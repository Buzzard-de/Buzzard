...
class PublicForumsAdapter(SocialPlatformAdapter):
    platform = "forums"
    ...
    def collect(self, source_config):
        ...
        return {"status":"not_configured","platform":"forums","source":source_config}

    def normalize(self, raw_items):
        return raw_items

    def health(self):
        return {"platform":"forums","status":"ready_for_authorized_connector"}
