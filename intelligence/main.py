...
def main():
    ...
    sub.add_parser(
        "complete-category-intelligence-47-max-final-single-file",
        help="Show 47 category intelligence MAX FINAL single-file console summary",
    )
    sub.add_parser(
        "complete-build-category-intelligence-47-max-final",
    ...
    sub.add_parser(
        "complete-category-intelligence-47-final-max-single-file",
        help="Show 47 category intelligence FINAL MAX console summary",
    )
    sub.add_parser(
        "complete-build-category-intelligence-47-final-max",
        help="Build 47 category intelligence FINAL MAX console with evidence orchestration",
    )
    sub.add_parser(
        "complete-category-intelligence-47-final-manifest",
        help="Show BUZZARD FINAL 47 Category Intelligence manifest",
    )
    sub.add_parser(
        "complete-category-intelligence-47-final-manifest-summary",
        help="Show FINAL manifest with runtime console and API bindings",
    )
    sub.add_parser(
    ...
    if args.cmd == "init":
        ...
        print(f"Buzzard Voice: http://{args.host}:{args.port}")
        print("Tip: cd Buzzard && python app.py")
    ...
    elif args.cmd == "complete-sync-turkish-48-main-categories":
    ...
    elif args.cmd == "complete-category-intelligence-47-max-final-single-file":
        from buzzard_ai_complete.commands import complete_category_intelligence_47_max_final_single_file

        print(complete_category_intelligence_47_max_final_single_file())
    elif args.cmd == "complete-build-category-intelligence-47-max-final":
    ...
    elif args.cmd == "complete-category-intelligence-47-final-max-single-file":
        from buzzard_ai_complete.commands import complete_category_intelligence_47_final_max_single_file

        print(complete_category_intelligence_47_final_max_single_file())
    elif args.cmd == "complete-build-category-intelligence-47-final-max":
        from buzzard_ai_complete.commands import complete_build_category_intelligence_47_final_max

        print(complete_build_category_intelligence_47_final_max())
    elif args.cmd == "complete-category-intelligence-47-final-manifest":
        from buzzard_ai_complete.commands import complete_category_intelligence_47_final_manifest

        print(complete_category_intelligence_47_final_manifest())
    elif args.cmd == "complete-category-intelligence-47-final-manifest-summary":
        from buzzard_ai_complete.commands import complete_category_intelligence_47_final_manifest_summary

        print(complete_category_intelligence_47_final_manifest_summary())
