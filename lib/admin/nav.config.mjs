...
export const ADMIN_NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { slug: "control-center", label: "Control Center" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "pim-core", label: "PIM Core" },
      { slug: "global-catalog", label: "Global Catalog" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "returns", label: "Return & Recovery" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "analytics-foundation", label: "Analytics KPI Layer" },
      { slug: "analytics-v39", label: "Analytics v3.9" },
      { slug: "identity-security", label: "Security v2.0" },
      { slug: "security-dashboard", label: "Security Log" },
