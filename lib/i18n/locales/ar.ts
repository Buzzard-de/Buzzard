...
export const catalog: TranslationTree = {
  ...
  home: {
    ...
    newsletterSuccess: "شكرًا! تم استلام اشتراكك.",
    newsletterRateLimit: "يرجى الانتظار قليلًا قبل الإرسال مرة أخرى.",
    newsletterInvalid: "يرجى إدخال عنوان بريد إلكتروني صالح.",
  ...
  contactForm: {
    ...
    errorTooFast: "يرجى تعبئة النموذج قليلاً ثم المحاولة مجددًا.",
    altEmail: "أو راسلنا مباشرة:",
  },
  country: {
    DE: "ألمانيا",
    AT: "النمسا",
  ...
  automotive: {
    ...
    nav: { subcategories: "الفئات الفرعية" },
    empty: {
      title: "لا توجد منتجات متاحة",
      text: "لا توجد منتجات حاليًا في هذه الفئة. وضع التطوير — المبيعات غير مفعلة.",
    },
    vehicle: {
      label: "توافق المركبة",
      placeholder: "لم يتم اختيار مركبة — استخدم التنقل لاختيار مركبة",
    },
    filters: {
      title: "الفلاتر",
      any: "الكل",
      tireWidth: "عرض الإطار",
      aspectRatio: "نسبة العرض",
      rimDiameter: "قطر الجنط",
      season: "الموسم",
      loadIndex: "مؤشر الحمل",
      speedRating: "تصنيف السرعة",
      brand: "العلامة",
      viscosity: "اللزوجة",
      capacity: "السعة",
      oilType: "نوع الزيت",
      ...
      voltage: "الجهد",
      capacityAh: "السعة (Ah)",
      cca: "تيار التشغيل البارد",
      technology: "التقنية",
      filterType: "نوع الفلتر",
      discDiameter: "قطر القرص",
      axlePosition: "موضع المحور",
    },
    sort: { default: "افتراضي", name: "الاسم", brand: "العلامة" },
    search: { placeholder: "البحث في منتجات السيارات…" },
  },
};
