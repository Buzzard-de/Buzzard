...
export const catalog: TranslationTree = {
  ...
  home: {
    ...
    newsletterSuccess: "Vielen Dank! Wir haben Ihre Anmeldung erhalten.",
    newsletterRateLimit: "Bitte warten Sie einen Moment, bevor Sie erneut senden.",
    newsletterInvalid: "Bitte geben Sie eine gültige E-Mail-Adresse ein.",
    newsletterUnavailable: "Newsletter ist derzeit nicht verfügbar. Bitte versuchen Sie es später erneut.",
    newsletterError: "Anmeldung fehlgeschlagen. Bitte versuchen Sie es später erneut.",
    newsletterSubmitting: "Wird gesendet…",
  ...
  catalog: {
    ...
    browseOnlyText: "Der Online-Checkout ist derzeit nicht aktiv. Produkte und Kategorien können Sie vollständig ansehen — Preise folgen mit Verkaufsstart.",
  ...
  automotive: {
    ...
    nav: { subcategories: "Unterkategorien" },
    empty: {
      title: "Keine Produkte verfügbar",
      text: "In dieser Kategorie sind derzeit keine Produkte hinterlegt. Der Katalog bleibt im Entwicklungsmodus — ohne Verkaufsfreigabe.",
    },
    vehicle: {
      label: "Fahrzeugkompatibilität",
      placeholder: "Kein Fahrzeug ausgewählt — Fahrzeugwahl über die Navigation",
    },
    filters: {
      title: "Filter",
      any: "Alle",
      ...
      cca: "Kaltstartstrom (CCA)",
      technology: "Technologie",
      filterType: "Filtertyp",
      discDiameter: "Scheibendurchmesser",
      axlePosition: "Achsposition",
    },
    sort: { default: "Standard", name: "Name", brand: "Marke" },
    search: { placeholder: "Automotive-Produkte suchen…" },
  },
};
