...
export const catalog: TranslationTree = {
  ...
  home: {
    ...
    newsletterSuccess: "Thank you! We received your subscription.",
    newsletterRateLimit: "Please wait a moment before submitting again.",
  ...
  account: {
    ...
    loyaltyLead: "Earn points, redeem rewards and manage marketing consent.",
    loyaltyPoints: "Points",
    loyaltyTier: "Tier",
    loyaltyLifetime: "Lifetime points",
    loyaltyRewards: "Rewards",
    loyaltyNoRewards: "No rewards available.",
    loyaltyRedeem: "Redeem",
    loyaltyRedeemed: "Offer code {code} was created.",
    loyaltyOffers: "My offers",
    loyaltyNoOffers: "No personalized offers yet.",
    loyaltyHistory: "Points history",
    loyaltyNoHistory: "No point movements yet.",
    loyaltyConsent: "Marketing consent",
    loyaltyUnavailable: "Loyalty program is currently unavailable.",
    loyaltyLoading: "Loading loyalty program…",
  ...
  automotive: {
    ...
    empty: {
      ...
      text: "There are currently no products in this category. The catalog remains in development mode — sales are not enabled.",
    },
    vehicle: {
      label: "Vehicle compatibility",
      placeholder: "No vehicle selected — use navigation to select a vehicle",
    },
    filters: {
      title: "Filters",
      any: "Any",
    ...
    sort: { default: "Default", name: "Name", brand: "Brand" },
    search: { placeholder: "Search automotive products…" },
  },
};
