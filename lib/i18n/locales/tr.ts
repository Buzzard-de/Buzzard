...
export const catalog: TranslationTree = {
  ...
  home: {
    ...
    newsletterSuccess: "Teşekkürler! Aboneliğiniz alındı.",
    newsletterRateLimit: "Tekrar göndermeden önce lütfen biraz bekleyin.",
  ...
  account: {
    ...
    supportLead: "Destek talebi oluşturun ve gönderileri takip edin.",
    supportNew: "Yeni talep",
    supportSubject: "Konu",
    supportMessage: "Mesaj",
    supportSubmit: "Talep oluştur",
    supportCreated: "Talep {ticket} oluşturuldu.",
    supportTickets: "Taleplerim",
    supportNoTickets: "Henüz destek talebi yok.",
    supportReply: "Yanıt",
    supportSendReply: "Yanıt gönder",
    supportTracking: "Kargo takibi",
    supportTrack: "Takip et",
    supportNoTracking: "Bu sipariş için takip kaydı yok.",
    supportUnavailable: "Destek merkezi şu anda kullanılamıyor.",
    supportLoading: "Destek yükleniyor…",
    optional: "isteğe bağlı",
    loyaltyTitle: "Sadakat programı",
    loyaltyLead: "Puan kazanın, ödülleri kullanın ve pazarlama izinlerini yönetin.",
    loyaltyPoints: "Puan",
    loyaltyTier: "Seviye",
    loyaltyLifetime: "Toplam puan",
    loyaltyRewards: "Ödüller",
    loyaltyNoRewards: "Ödül yok.",
    loyaltyRedeem: "Kullan",
    loyaltyRedeemed: "Teklif kodu {code} oluşturuldu.",
    loyaltyOffers: "Tekliflerim",
    loyaltyNoOffers: "Henüz kişisel teklif yok.",
    loyaltyHistory: "Puan geçmişi",
    loyaltyNoHistory: "Henüz puan hareketi yok.",
    loyaltyConsent: "Pazarlama izinleri",
    loyaltyUnavailable: "Sadakat programı şu anda kullanılamıyor.",
    loyaltyLoading: "Sadakat programı yükleniyor…",
  ...
  contactForm: {
    ...
    messageLabel: "Mesajınız / sorunuz",
    ...
    errorTooFast: "Lütfen formu kısa süre doldurup tekrar deneyin.",
    altEmail: "Alternatif olarak doğrudan e-posta:",
  },
  country: {
    DE: "Almanya",
    AT: "Avusturya",
  ...
  automotive: {
    ...
    nav: { subcategories: "Alt kategoriler" },
    empty: {
      title: "Ürün bulunmuyor",
      text: "Bu kategoride şu anda ürün yok. Katalog geliştirme modundadır — satış etkin değildir.",
    },
    vehicle: {
      label: "Araç uyumluluğu",
      placeholder: "Araç seçilmedi — navigasyondan araç seçin",
    },
    filters: {
      title: "Filtreler",
      any: "Tümü",
      tireWidth: "Lastik genişliği",
      aspectRatio: "Kesit oranı",
      rimDiameter: "Jant çapı",
      season: "Mevsim",
      loadIndex: "Yük indeksi",
      speedRating: "Hız indeksi",
      brand: "Marka",
      viscosity: "Viskozite",
      capacity: "Hacim",
      oilType: "Yağ tipi",
      ...
      approval: "Onay",
      voltage: "Voltaj",
      capacityAh: "Kapasite (Ah)",
      cca: "Soğuk çalıştırma akımı",
      technology: "Teknoloji",
      filterType: "Filtre tipi",
      discDiameter: "Disk çapı",
      axlePosition: "Aks konumu",
    },
    sort: { default: "Varsayılan", name: "Ad", brand: "Marka" },
    search: { placeholder: "Otomotiv ürünlerinde ara…" },
  },
};
