...
await esbuild.build({
  entryPoints: [path.join(root, "lib/analytics/storefront/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/analyticsFoundation.bundle.cjs"),
  alias: {
    "@": root,
  },
  banner: {
...
console.log("Built server/lib/analyticsFoundation.bundle.cjs");
