...
await esbuild.build({
  entryPoints: [path.join(root, "lib/final-external-access/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/finalExternalAccess.bundle.cjs"),
  alias: { "@": root },
...
console.log("Built server/lib/finalExternalAccess.bundle.cjs");
