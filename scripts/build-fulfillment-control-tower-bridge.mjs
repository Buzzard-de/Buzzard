...
await esbuild.build({
  entryPoints: [path.join(root, "lib/fulfillment-control-tower/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/fulfillmentControlTower.bundle.cjs"),
  alias: {
    "@": root,
  },
  banner: {
...
console.log("Built server/lib/fulfillmentControlTower.bundle.cjs");
