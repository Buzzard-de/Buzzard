...
await esbuild.build({
  entryPoints: [path.join(root, "lib/supplier-controlled-go-live/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/supplierControlledGoLive.bundle.cjs"),
  alias: { "@": root },
...
console.log("Built server/lib/supplierControlledGoLive.bundle.cjs");
