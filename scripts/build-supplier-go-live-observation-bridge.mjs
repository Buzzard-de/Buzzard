...
await esbuild.build({
  entryPoints: [path.join(root, "lib/supplier-go-live-observation/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/supplierGoLiveObservation.bundle.cjs"),
  alias: { "@": root },
...
console.log("Built server/lib/supplierGoLiveObservation.bundle.cjs");
