...
await esbuild.build({
  entryPoints: [path.join(root, "lib/supplier-inter-cars-production-access/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/supplierInterCarsProductionAccess.bundle.cjs"),
  alias: { "@": root },
...
console.log("Built server/lib/supplierInterCarsProductionAccess.bundle.cjs");
