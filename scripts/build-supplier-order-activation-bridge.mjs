...
await esbuild.build({
  entryPoints: [path.join(root, "lib/supplier-order-activation/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/supplierOrderActivation.bundle.cjs"),
  alias: {
    "@": root,
  },
  banner: {
...
console.log("Built server/lib/supplierOrderActivation.bundle.cjs");
