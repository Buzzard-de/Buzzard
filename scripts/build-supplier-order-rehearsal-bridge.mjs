...
await esbuild.build({
  entryPoints: [path.join(root, "lib/supplier-order-rehearsal/serverEntry.ts")],
  bundle: true,
  platform: "node",
  format: "cjs",
  outfile: path.join(root, "server/lib/supplierOrderRehearsal.bundle.cjs"),
  alias: {
    "@": root,
  },
  banner: {
...
console.log("Built server/lib/supplierOrderRehearsal.bundle.cjs");
