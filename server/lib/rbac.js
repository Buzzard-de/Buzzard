const PERMISSIONS = {
  ...
  admin: [
    ...
    "supplier-first-production-order.read",
    "supplier-first-production-order.request",
    "supplier-first-production-order.approve",
    "supplier-first-production-order.execute",
    "supplier-first-production-order.admin",
    "supplier-controlled-go-live.read",
    "supplier-controlled-go-live.review",
    "supplier-controlled-go-live.approve",
    "supplier-controlled-go-live.activate",
    "supplier-controlled-go-live.rollback",
    "supplier-controlled-go-live.admin",
    "supplier-observation.read",
    "supplier-observation.manage",
    "supplier-observation.review",
    "supplier-rollout.approve",
    "supplier-rollout.activate",
    "supplier-rollout.rollback",
  ],
  catalog_manager: [
    "products.read",
    "products.write",
