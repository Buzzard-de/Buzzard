...
const { evaluateFinalProductionGovernance } = require('./finalProductionGovernance');
...
function auditFinalProductionGovernance(input = {}) {
  ...
  return Object.freeze({
    auditType: 'FINAL_PRODUCTION_GOVERNANCE',
    part: 35,
    readOnly: true,
    diagnosticOnly: true,
    ready: false,
